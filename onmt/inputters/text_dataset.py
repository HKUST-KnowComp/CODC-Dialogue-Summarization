...
class TextMultiField(RawField):
    ...
    def __init__(self, base_name, base_field, feats_fields, elmo):
    ...
    def process(self, batch, device=None):
        ...
        # if 'elmo' in self.__dict__ and self.elmo:
        #     if self.base_field.include_lengths:
        #         # print('batch_by_feat', batch_by_feat)
        #         return data, batch_to_ids(list(batch_by_feat[0])), lengths # for src only
        #     else:
        #         return data
...
def text_fields(**kwargs):
    ...
    field = TextMultiField(fields_[0][0], fields_[0][1], fields_[1:], elmo=elmo)
    return field
