...
from onmt.modules.global_attention import GlobalAttention, KnowledgeAttention
...
from onmt.modules.copy_generator import KnowGenerator, KnowGeneratorLoss, \
    KnowGeneratorLossCompute
...
__all__ = ["Elementwise", "context_gate_factory", "ContextGate",
           ...
           "KnowledgeAttention", "KnowGenerator", "KnowGeneratorLoss", 
           "KnowGeneratorLossCompute"]
