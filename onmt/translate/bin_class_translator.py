...
class BinClassTranslator(object):
    ...
    def _run_encoder(self, batch):
        ...
        assert elmo_src is not None

        enc_states, memory_bank, src_lengths = self.model.encoder(elmo_src, src_lengths, self._dev)
    ...
    def _run_decoder(self, src, enc_states, memory_bank, src_lengths):
        ...
        # print(tgt.size()) self.decoder(enc_state, memory_bank, tgt, src_lengths, tgt_length)
        scores = self.model.decoder(enc_states, memory_bank, tgt, src_lengths, tgt_length)
