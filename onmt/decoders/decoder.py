...
class InputFeedRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, memory_lengths=None, know=None, know_lengths=None,
        ...
        Then k_star_context is added to P_vocab equation (这里可以有两种方法，第一种是h_*和k*_context share attention，一种是各自attention) 都可以试一下喽
            ...
            if self.attentional:
                ...
                if self._know_attn:
                    ...
                    if input_know_vecs is not None:
                        if self.know_star_attn_share: # 用同一个attention parameter来
                        ...
                        else: # 这个就相当于s_t attend to [{h_i}, {k_star_i}], 得到两个Attention[a_i_t, b_i_t]
