...
class RNNDecoderBase(DecoderBase):
    ...
    def forward(self, tgt, memory_bank, memory_lengths):
        ...
        dec_state, dec_outs, attns = self._run_forward_pass(tgt, memory_bank, memory_lengths)
...
class BOWDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, memory_lengths):
        """
